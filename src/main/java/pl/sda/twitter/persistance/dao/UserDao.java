...
//DAO - data access object - ZA JEGO POMOCĄ POBIERAMY BĄDŹ ODBIERAMY DANE
...
public class UserDao {
    ...
    public TbUser getUserByLogin(String login) {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            ...
            Query q = session.createQuery("select e from " + TbUser.class.getName() + " e where e.login =:username"); //alt_ctrl +v
